report 50030 "Vega Suggest Bank Acc Lines"
{
    ...
    dataset
    {
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            begin
                ...
                //vega KTM-
                BankAccReconDateFilter.GET(BankAccRecon."Statement Type", BankAccRecon."Bank Account No.", BankAccRecon."Statement No.");
                BankAccReconDateFilter."Start Date" := StartDate;
                BankAccReconDateFilter."End Date" := EndDate;
                BankAccReconDateFilter.MODIFY;
                //vega KTM +
            end;
        }
    }
    ...
    var
        ...
        BankAccReconDateFilter: Record "Bank Acc. Reconciliation";
